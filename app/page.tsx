...
export default function Home() {
  ...
  const url = `https://api.weatherapi.com/v1/forecast.json?key=ee4b05fcbdab4645ab7100356231112&q=${location}&days=7&aqi=yes&alerts=yes`;
  ...
  return (
    <div className="bg-cover bg-gradient-to-r from-purple-800 to-purple-600 h-fit">
